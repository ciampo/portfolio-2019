          ...
          <h1 className="contain-layout-paint text-primary bg-background z-10 pointer-events-none home-logo-title">
            ...
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 172 134">
              <g fill="none" fillRule="evenodd">
                <path
                  d="M33.2 37.8l9-22h5.5V44h-4.5V24.3L35 44h-3.5l-8.3-19.8V44h-4.4V15.7h5.4l9 22zm29.1-6.3v-1.3c0-2.1-1.4-3.4-3.8-3.4-2.3 0-3.8 1-4.1 2.8v.2h-4.5v-.3c.3-3.9 3.7-6.6 8.7-6.6 5.1 0 8.4 2.7 8.4 7V44h-4.5v-2.8a7.7 7.7 0 01-6.3 3.2C52 44.5 49 41.9 49 38c0-3.7 2.9-6 7.9-6.3l5.3-.3zm0 3.4l-4.7.3c-2.4.2-3.7 1.2-3.7 2.8 0 1.6 1.3 2.7 3.4 2.7 2.9 0 5-2 5-4.4v-1.4zm11.4-9c.9-1.8 2.6-3 4.7-3l1.5.2h.2v4.5l-.3-.1a6 6 0 00-1.8-.2c-2.6 0-4.1 1.7-4.1 4.4v12.4h-4.7V23.3h4.5V26zM89 44.5c-6.1 0-10-4.1-10-10.8C79 27.2 83 23 89 23c5 0 8.6 3.2 9 7.6v.3h-4.4v-.2a4.4 4.4 0 00-4.6-3.7c-3.2 0-5.2 2.6-5.2 6.8 0 4.3 2 6.8 5.2 6.8 2.4 0 4-1.3 4.5-3.5v-.2h4.6v.2c-.5 4.5-4.1 7.5-9.1 7.5zm19.2 0c-6.1 0-10-4.2-10-10.8 0-6.6 4-10.8 10-10.8s10 4.2 10 10.8c0 6.6-4 10.8-10 10.8zm0-4c3.2 0 5.2-2.5 5.2-6.8s-2-6.8-5.2-6.8-5.2 2.5-5.2 6.8 2 6.9 5.2 6.9zM30.9 76c-8 0-13.1-5.7-13.1-14.7s5-14.6 13-14.6c6.6 0 11.5 4 12.3 9.9v.3h-4.8v-.2a7.2 7.2 0 00-7.4-5.7c-5 0-8.2 4-8.2 10.3 0 6.4 3.2 10.4 8.2 10.4 3.8 0 6.5-2 7.3-5.2v-.2h5l-.1.3c-1.1 6-5.6 9.4-12.2 9.4zM47 52a2.7 2.7 0 01-2.7-2.7c0-1.5 1.2-2.7 2.7-2.7a2.6 2.6 0 110 5.3zm2.3 2.7v20.8h-4.7V54.7h4.7zm14.8 8.2v-1.3c0-2.1-1.4-3.4-3.9-3.4-2.2 0-3.7 1-4 2.8v.2h-4.5V61c.2-3.9 3.6-6.6 8.7-6.6 5 0 8.4 2.7 8.4 7v14.2h-4.6v-2.8a7.7 7.7 0 01-6.3 3.2c-4.1 0-7-2.6-7-6.4 0-3.7 2.8-6 7.8-6.3l5.4-.3zm0 3.4l-4.8.3c-2.4.2-3.7 1.2-3.7 2.8 0 1.6 1.4 2.7 3.5 2.7 2.8 0 5-2 5-4.4v-1.4zm11.3-8.8c1.1-2 3.2-3.2 5.7-3.2 2.8 0 4.9 1.4 5.8 3.7a7 7 0 016.4-3.7c4.2 0 7 2.8 7 7v14.2h-4.8V62.3c0-2.5-1.3-3.9-3.6-3.9-2.4 0-4 1.7-4 4.2v13h-4.6V62c0-2.2-1.4-3.6-3.7-3.6-2.3 0-4 1.8-4 4.3v12.8H71V54.7h4.5v2.8zm31.6.2c1.3-2.1 3.6-3.3 6.3-3.3 5.4 0 8.9 4.2 8.9 10.7 0 6.5-3.5 10.8-8.8 10.8-2.7 0-5-1.2-6.3-3.2v9.5h-4.7V54.8h4.6v3zm5.2 14.1c3.2 0 5.2-2.5 5.2-6.7 0-4.1-2-6.7-5.2-6.7-3 0-5.1 2.7-5.1 6.7 0 4.1 2 6.7 5.1 6.7zM126.1 52a2.7 2.7 0 01-2.7-2.6c0-1.5 1.2-2.7 2.7-2.7a2.6 2.6 0 110 5.3zm2.3 2.8v20.8h-4.7V54.7h4.7zm7 2.8c1.2-2 3.4-3.2 6.2-3.2 4.6 0 7.4 3 7.4 7.8v13.4h-4.8V63c0-3-1.3-4.5-4-4.5-2.9 0-4.7 2-4.7 5v12.1h-4.7V54.7h4.5v2.8zm18.2-5.6a2.7 2.7 0 01-2.7-2.6c0-1.5 1.2-2.7 2.7-2.7a2.6 2.6 0 110 5.3zm2.3 23.6h-4.7V54.7h4.7v20.8z"
                  stroke="currentColor"
                  strokeWidth="0.05rem"
                  fillOpacity=".05"
                  fill="currentColor"
